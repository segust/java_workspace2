      ...
      <%@include file="../../../ConstantHTML/jdjleft.html" %>
		...
		result = (ArrayList<HashMap<String, String>>)request.getAttribute("result");
       	...
       	<!-- 二级标题 -->
      		...
      		<!-- 内容区 -->
      		<div class="content">
      			<div class="search-box" style="background-color: #2E8B57;" >
      			<form class="add-storage" action="Maintain?operateType=maintainQuery&curPageNum=1&pageSize=10" method="post">
        			...
        			<input  type="submit" class="search-btn" value="查询" style="background-color: #3CB371">		
    			</form>
      		</div>
  			<div id="contract-table-box">
				...
				<td style="background-color: #669966;">企业下次维护日期</td>
				<td style="background-color: #669966;">承制单位</td>
				<td style="background-color: #669966;">代储单元</td>
        		<td style="background-color: #669966;">用户名</td>
        		<td style="background-color: #669966;">维护类别</td>
        		<td style="background-color: #669966;">备注</td>
        		</tr>
        		</thead>
        		<tbody>
					<%
