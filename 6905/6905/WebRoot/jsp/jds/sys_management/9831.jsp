		...
		<div class="fare-data" id="fare-data">
			<div class="search_box">
				<form id="9832-Slt-form">
					...
					<span> 
					<input name="codeSubmit" class="scan-btn"
						type="button" value="查询" class="scan_btn" onclick="slt9831ByCdt(1);">  
					<input
						type="button" class="scan-btn"
						onclick="window.location.href='../6905/jsp/qy/sys_management/add_9831.jsp'"
						value="加入新纪录" id="add_new"> 
					<input type="button"
				...
				<table id="fare-table">
					...
					<tbody id="9831-info-table">
						...
						<tr class="contract-add-table-body">
							<td><input type="checkbox" name="check_9831" />
							</td>
