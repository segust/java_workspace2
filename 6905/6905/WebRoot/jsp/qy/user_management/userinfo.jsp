...
<body>
				...
				<div class="userinfo-op">
					<form
						...
						<select name="searchType" id="searchType">
							...
							onclick="window.location.href='jsp/qy/user_management/adduser.jsp?curPageNum=<%=curPageNum%>&pageSize=<%=pageSize%>'">
					</form>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		if(deleteFlag==1)
			...
			window.wxc.xcConfirm("删除失败或重复提交删除操作","error");
	</script>
	<script type="text/javascript">
	...
	<script type="text/javascript">
			function updateUser(ev){
				...
				url = "jsp/qy/user_management/updateuser.jsp?identifyNum="
