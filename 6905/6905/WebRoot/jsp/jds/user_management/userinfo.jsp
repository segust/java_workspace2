...
<body>
				...
				<div class="userinfo-op">
					<form
						...
						<select name="searchType" id="searchType">
							...
							onclick="window.location.href='jsp/jds/user_management/adduser.jsp?curPageNum=<%=curPageNum%>&pageSize=<%=pageSize%>'">
					</form>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
			function updateUser(ev){
				...
				url = "jsp/jds/user_management/updateuser.jsp?identifyNum="
