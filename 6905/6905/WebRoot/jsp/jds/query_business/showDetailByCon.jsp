	...
	<div id="right">
				...
				<table class="fare-table" id="fare-table">
					...
					<tbody>
						...
						<tr class="contract-add-table-body">
							...
							%>
							<td><%=recordList.size() - (curPageNum-1)*10 -i%></td>
		...
		<div class="page-box">
			<span> <a
				...
				<span><font color="black"><%=curPageNum %></font> </span> <a
			...
			</span> <span><font color="black">跳到第</font> </span> <input type="text"
				id="skipPageNum" /> <span><font color="black">页</font> </span> <a
				onclick='skipPage()'>确定</a> <span><font color="black">每页显示</font>
			</span> <select name="selectPageSize" onchange='selectPageSize(this.value)'
				id="selectPageSize">
				<option value="10">10</option>
				<option value="15">15</option>
				<option value="20">20</option>
			</select> <span><font color="black">条记录，共</font> </span> <label> <font
				color="black">1</font>
			</label> <span><font color="black">页</font> </span>
		</div>
		<!-- 分页的盒子结束 -->
		<!-- 内容区结束 -->
	</div>
