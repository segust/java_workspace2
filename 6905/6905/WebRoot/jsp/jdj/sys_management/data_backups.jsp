     ...
     <ul>
      ...
      <li>
        <form action="${pageContext.request.contextPath}/SystemManagementServlet?operate=LoadIn" enctype="multipart/form-data" method="post">
          <input type="text" size="20" name="upfile" id="upfile" style="padding:5px 0;border:1px dotted black;width: 200px;float: none;">  
          <input type="button" value="浏览文件" onclick="path.click()">  
          <input type="file" id="path" name="attachment" style="display:none" onchange="upfile.value=this.value">
