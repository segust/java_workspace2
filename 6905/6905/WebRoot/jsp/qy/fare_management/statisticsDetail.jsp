		  ...
		  //long sum=(Long)request.getAttribute("fareSum");
			...
			<div class="fare-data" id="fare-data">
				<form name="checkForm" method="post">
					<div id="search-box">
						<p>
							<input type="hidden" name="builtType"> 费用类型 <input
								type="checkbox" id="box" onclick="allSelect()" /> 
								<!-- <label for="1">器材购置费</label><input
								id="1" name="fareType" type="checkbox" value="器材购置费"> --> 
								<label
								for="2">运杂费</label><input id="2" name="fareType" type="checkbox"
								value="运杂费"> <label for="3">轮换费</label><input id="3"
								name="fareType" type="checkbox" value="轮换费"> <label
								for="6">维护保养费</label><input id="6" name="fareType"
								type="checkbox" value="维护保养费"> <label for="8">其他</label><input
								id="8" name="fareType" type="checkbox" value="其他">
						</p>
						<p>
							明细时间段：<input type="text" id="startDate" class="sang_Calender"
								name="startTime" value="<%=request.getAttribute("startTime") %>" />
							到 <input type="text" id="endDate" class="sang_Calender"
								name="endTime" value="<%=request.getAttribute("endTime") %>" />
							<script src="ConstantHTML/js/spdateTime.js"></script>
							<span class="btn"> <input class="search-btn" type="button"
