	...
	<div id="right">
		...
		<div class="fare-data" id="fare-data">
			<div class="search_box">
				<form action="StatisticsQueryServlet?operate=productStatistic"
					...
					<span>产品型号</span> <span><input type="text"
						name="productModel" />
					</span> <span>产品单元</span> <span><input type="text"
						name="productUnit" />
					</span> <input type="submit" value="查询"> <input type="button"
			...
			<div id="detail_by_product">
				...
				<div>
					<p></p>
					<input type="button" value="确定" class="scan-btn" style="float:right;" id="sure_product">
				</div>
			</div>
					...
					<tbody>
						<tr class="contract-add-table-body">
							...
							<td><input type="button" value="查看合同信息"
								onclick="out_detail_product(this)">
							</td>
							<%}%>
						</tr>
					</tbody>
