...
public class Unit {
	...
	public String getFKPMNM() {
		return FKPMNM;
	}

	public void setFKPMNM(String fKPMNM) {
		FKPMNM = fKPMNM;
	}
	...
	private String FKPMNM="";//单元外部每一类的PMNM
	private int flag=0;
	
	public Unit(String PMNM,String PMBM,String QCBM,String PMCS,String XHTH,String XLDJ,
			String XHDE,String JLDW,String MJYL,String QCXS, String BZZL,String BZJS,String BZTJ,String CKDJ,String SCCJNM,
			String GHDWNM,String ZBSX,String LBQF,String ZBBDSJ,String SYBZ,String YJDBZ,String SCBZ,String SCDXNF,String FKPMNM,int flag){
		super();
		this.PMNM=PMNM;
		this.PMBM=PMBM;
		this.QCBM=QCBM;
