	...
	public addBookFrame() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(action.addBook(textField.getText(),textField_1.getText(), Integer.parseInt(textField_2.getText()),textField_3.getText())==1){
					textField_4.setText("添加成功！");
					textField.setText("");
					textField_1.setText("");
					textField_2.setText("");
					textField_3.setText("");
				}else{
					textField_4.setText("添加失败！");
				}
			}
		});
