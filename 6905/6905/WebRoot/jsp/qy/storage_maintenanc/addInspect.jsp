		...
		<div class="content">
			<div class="search-box">
				<form class="add-storage" 
					action="InspectServlet?operate=inspect&curPageNum=1&pageSize=10"
					method="post">
					...
					<input type="button" class="search-btn" value="军代室检查" onclick="jdsCheckInspect();" style="width: 85px;">
			...
			<table id="contract-table">
				<thead>
					<tr>
						<th>
							<input type="checkbox" onclick=" checkall();" id="checkLeader">
						</th>
						<th>序号</th>
						<th>产品型号</th>
						<th>单元名称</th>
