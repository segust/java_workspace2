 ...
 * 
 * onOk: $.noop,//点击确定的按钮执行的函数
 * onCancel: $.noop,//点击取消的按钮执行的函数
 * onClose: $.noop//弹窗关闭的执行的函数 
 */
(function($) {
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		function creatDom() {
			 ...
			 */
			$ttBox.append($tt));
			$popBox.append($txtBox.append($icon).append($txt)).append($btnArea.append(creatBtnGroup(btn)));
