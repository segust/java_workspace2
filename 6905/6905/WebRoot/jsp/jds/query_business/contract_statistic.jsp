...
<body>
			...
			<div class="search_box">
				<form action="StatisticsQueryServlet?operate=contractStatistic"
					...
					<span>合同编号</span> <span><input type="text" name="contractId">
						...
						id="contractYear"> </span> <span>代储企业</span> <select
						name="keeper" id="keeper">
						<option value="all">所有代储企业</option>
						<%
									String ownedUnit=(String)request.getSession().getAttribute("ownedUnit");
									ArrayList<String> companyList=new InfoService().getCompanyNameList(ownedUnit, 2);
						...
						value="导出" onclick="outAll_contractstatistic();">
				</form>
			</div>
			<div id="whole"></div>
	...
	<script type="text/javascript">
				var keeper="<%=request.getAttribute("keeper")%>";
				if(keeper=="null")
					document.getElementById("keeper").value="all";
				else
