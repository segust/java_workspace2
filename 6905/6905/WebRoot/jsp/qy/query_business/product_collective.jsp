  ...
  <body>
      ...
      <%@include file="../../../ConstantHTML/left.html" %>
      	<div id="right">
      		...
      		<div class="subName">
      			<span>当前位置：</span>
      			<a href="ProductQueryServlet?operate=productDetailQuery">业务查询</a>&nbsp;&nbsp;>&nbsp;&nbsp;业务查询&nbsp;&nbsp;>&nbsp;&nbsp;
      		...
      		<div class="search_box">
				<form action="ProductQueryServlet?operate=productCollectiveQuery" method="post">
					<span>产品型号</span><span><input type="text" name="productModel"/></span>
			        <span>产品单元</span><span><input type="text" name="productUnit"/></span>
			        <input type="submit" value="查询">
      			</form>
				<input type="button" value="导出" onclick="outAll_productcollective();">
			</div>
			...
			<div id="fare-table-box">
					<table class="fare-table" id="fare-table">
						<thead>
							<tr>
								<th rowspan="2"><input type="checkbox" onclick="chooseAll();" id="checkbox_product"></th>
								<th rowspan="2">序号</th>
