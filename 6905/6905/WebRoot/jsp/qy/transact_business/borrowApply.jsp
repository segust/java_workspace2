      	...
      	<div id="right">
      		...
      		<div class="subName">
				<span>当前位置：</span>
      			...
      			<a href="ProductQueryServlet?operate=borrowApply&flag=2">轮换出库申请</a>				
			</div>
      		<!-- 内容区 -->
      		<div class="fare-data" id="fare-data">
	      		<div class="search_box">
					<form action="ProductQueryServlet?operate=borrowApply" method="post" onsubmit="return judgeInputTime('restKeepTime','restMaintainTime')">
					<span >产品型号</span>
