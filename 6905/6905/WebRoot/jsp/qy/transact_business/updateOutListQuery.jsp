...
<body>
	...
	<div id="right">
		<div class="subName">
			<span>当前位置：</span>
      		<a href="OutListServlet?operate=selectOutListAllot">业务办理</a>&nbsp;&nbsp;>&nbsp;&nbsp;更新出库列表信息
		</div>
		<div id="content">
				...
				<table>
					...
					<% for(int i = 0;i<outList.size();i++) { %>
						<tr>
							...
							<td><input type="button" value="查看" onclick="window.location.href='OutListServlet?operate=selectDetail&type=update&listId=<%=outList.get(i).get("listId") %>'"></td>
						</tr>	
						<%} %>
					</tbody>
				</table>
