		...
		<div id="right">
			...
			<div class="page-box">
					<span> <a
						...
						<a
						href="UpdateQueryServlet?operate=updateQueryDetailByProductModel&curPageNum=<%=curPageNum %>&pageSize=<%=pageSize %>&productModel=<%=productModel %>">&lt;&lt;</a>
						<span><font color="black">1</font>
					</span> <a
						href="UpdateQueryServlet?operate=updateQueryDetailByProductModel&curPageNum=<%=totalPageNum %>&pageSize=<%=pageSize %>&productModel=<%=productModel %>">&gt;&gt;</a>
						<a
