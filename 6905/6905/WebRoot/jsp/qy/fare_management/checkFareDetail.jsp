			...
			<div class="add-box" id="fare-add-box">
				...
				<form id="edit-form"
					...
					<div class="add-mainfare-box" id="add-mainfare-box">
						<p>
							<label for="edit-type">费用类型:</label> <select name="type"
								id="edit-type">
						...
						<p>
							<label for="edit-price">总 &nbsp;金 &nbsp;额:</label> <input
								id="add-allmoney" class="edit-box-input" name="amount"
								value="<%=fare.getFareAmount()%>" type="text" readonly /> <input
								type="hidden" id="add-allmoney-hidden" value="">
						</p>
						<p>
							<label for="edit-remark"> 备
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注: </label> <input
								id="edit-remark" class="edit-box-input" name="remark"
								value="<%=fare.getRemark()%>" type="text" />
						</p>
						<p>
							<input type="button" class="addDetail-btn" value="返回"
