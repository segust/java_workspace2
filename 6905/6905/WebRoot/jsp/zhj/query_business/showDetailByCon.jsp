			...
			<!-- 分页的盒子开始 -->
				<div class="page-box">
					<span> <a
						...
						<a
						href="UpdateQueryServlet?operate=updateQueryDetailByProductId&curPageNum=<%=curPageNum %>&pageSize=<%=pageSize %>&productId=<%=productId %>">&lt;&lt;</a>
						<span><font color="black">1</font>
					</span> <a
						href="UpdateQueryServlet?operate=updateQueryDetailByProductId&curPageNum=<%=totalPageNum %>&pageSize=<%=pageSize %>&productId=<%=productId %>">&gt;&gt;</a>
						<a
