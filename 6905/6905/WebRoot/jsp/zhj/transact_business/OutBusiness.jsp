       ...
       <div id="content">
        ...
        <!-- <div class="toptitle">
          ...
          <div id="daorufaliaodantable" style="margin-top: 5px;">
			<form action="OutWarehouseServlet?operate=importOutlist" method="post" enctype="multipart/form-data">
			<center>
		...
		<tbody>
          ...
          <input type="button" value="选择文件" onclick="fileToUpload.click()">  
          <input id="fileToUpload" type="file" style="display:none" name="attachment"  accept="application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" onchange="upfile.value=this.value">
        </td>
				<td>
